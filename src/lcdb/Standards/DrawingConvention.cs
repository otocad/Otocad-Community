...
namespace lcdb.Standards
{
    ...
    public sealed class DrawingConvention
    {
        ...
        /// <summary>
        /// 图框模板轴(三轴之一,与基础格式/光学标注正交):决定出图用哪种零件图框。
        /// "gb-lens" = GbLensDrawingFrame(中文三列+GB/T 10609.1 标题栏);"iso-lens" = IsoLensDrawingFrame(英文)。
        /// 出图引擎 (StandardSheetEngine) 按此选框;随 .otocad 序列化(发图不丢模板选择)。
        /// </summary>
        public string FrameTemplateKey { get; set; } = "gb-lens";
        ...
        public DrawingConvention Clone() => new DrawingConvention
        {
            ...
            FrameTemplateKey = FrameTemplateKey,
        };
    }
}
