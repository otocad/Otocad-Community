...
namespace lcdb
{
    ...
    public class DimensionStyleConfig
    {
        ...
        /// <summary>
        /// 竖直标注文字是否竖排对齐 (true=竖排 GB/ISO; false=竖直标注也水平书写)。
        /// </summary>
        public bool? VerticalTextAligned { get; set; }
        ...
        public void ApplyToDimensionStyle(DimensionStyle style)
        {
            ...
            if (VerticalTextAligned.HasValue)
                style.VerticalTextAligned = VerticalTextAligned.Value;
        ...
        public static DimensionStyleConfig FromDimensionStyle(DimensionStyle style)
        {
            return new DimensionStyleConfig
            {
                ...
                VerticalTextAligned = style.VerticalTextAligned,
