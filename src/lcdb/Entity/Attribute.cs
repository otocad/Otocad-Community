...
namespace lcdb
{
    ...
    public class Attribute : Entity
    {
        ...
        /// 类名
        /// </summary>
        public override string className => "Attribute";
        ...
        // 关联的属性定义ID
        private ObjectId _attributeDefinitionId = ObjectId.Null;
        ...
        /// 关联的属性定义ID
        /// </summary>
        public ObjectId AttributeDefinitionId
        {
        ...
        public override Bounding bounding
        {
            get
            {
                double textWidth = _height * _value.Length * _widthFactor * 0.7;
        ...
        public Attribute(string tag, string value, Vector2 position, double height) : base()
        {
            _tag = tag;
            _value = value;
            _position = position;
        ...
        {
            Attribute attr = base.Clone() as Attribute;
            attr._tag = _tag;
            attr._value = _value;
            attr._position = _position;
            attr._height = _height;
            attr._rotation = _rotation;
            attr._widthFactor = _widthFactor;
            attr._obliqueAngle = _obliqueAngle;
            attr._textStyle = _textStyle;
            attr._alignment = _alignment;
            attr._flags = _flags;
            attr._alignmentPoint = _alignmentPoint;
            attr._isBackward = _isBackward;
            attr._isUpsideDown = _isUpsideDown;
            attr._attributeDefinitionId = _attributeDefinitionId;
            return attr;
        }
        ...
        /// 从属性定义同步设�?
        /// </summary>
        public void SyncFromDefinition(AttributeDefinition definition)
        {
            if (definition == null)
                return;
            ...
            _textStyle = definition.TextStyle;
            _alignment = definition.Alignment;
            _flags = definition.Flags;
            _isBackward = definition.IsBackward;
            _isUpsideDown = definition.IsUpsideDown;
