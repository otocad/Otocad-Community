...
namespace lcdb.Annotation
{
    ...
    public class SurfaceFormMark : Entity, IOpticalMark, ISurfaceAttachable
    {
        ...
        /// 标记文本内容
        /// </summary>
        public string MarkText { get; set; } = "3/2,3:-0.05";
        ...
        {
            MarkText = $"3/{ZernikeIndex}:{ToleranceValue:F3}";
        }
        ...
        /// <summary>
        /// ISO 10110-5 表面形状公差 (Zernike 项规范): 矩形框 + 居中代码 "3/index:tolerance".
        /// 注: ISO 10110 面形公差的指示代号是 "3/"(ISO 10110-10 代号表;非部件号 5).
        /// ISO 10110-5 第 8 章 Zernike 项格式: 3/i,j,...:T (i,j... 为 Zernike 索引, T 公差波数).
        /// </summary>
        private void GenerateMainSymbol()
        {
            ...
            // ISO 10110 面形公差代号: 主文字用 MarkText (用户可改), 默认由 UpdateMarkText 生成 "3/index:tolerance"
