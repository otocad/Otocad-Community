...
namespace lcdb.Annotation
{
    ...
    public class ISO10110_3Mark : Entity, IOpticalMark
    {
        ...
        private void GenerateMainSymbol()
        {
            ...
            // ISO 10110-3 严格格式 "1/N×A"
            string codeText = (BubbleCount > 0 && MaxBubbleDiameter > 0)
                ? $"1/{BubbleCount}×{MaxBubbleDiameter:G3}"
                : "1/—";
        ...
        private lcdb.Colors.Color GetMarkColor()
        {
            ...
            else if (BubbleClass <= 3)
                return lcdb.Colors.Color.FromColor(System.Drawing.Color.Orange);   // 中等
            else
                return lcdb.Colors.Color.FromColor(System.Drawing.Color.Blue);     // 一般
        }
        #endregion
