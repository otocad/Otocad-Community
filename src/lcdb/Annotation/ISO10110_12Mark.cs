...
namespace lcdb.Annotation
{
    ...
    public class ISO10110_12Mark : Entity, IOpticalMark
    {
        ...
        public string MarkText { get; set; } = "12/A";
        ...
        /// 非球面类型 (A=轴对称, F=自由曲面)
        /// </summary>
        public AsphericType SurfaceType { get; set; } = AsphericType.Axisymmetric;
        ...
        /// 斜率偏差公差 (arcmin)
        /// </summary>
        public double SlopeDeviation { get; set; } = 1.0;
        ...
        public ISO10110_12Mark(Vector2 position, double formDeviation, double slopeDeviation)
        {
            Position = position;
            FormDeviation = formDeviation;
            SlopeDeviation = slopeDeviation;
            UpdateMarkText();
        }
        #endregion
        ...
        {
            string typeCode = SurfaceType == AsphericType.Axisymmetric ? "A" : "F";
            MarkText = $"12/{typeCode} {FormDeviation:F2}/{SlopeDeviation:F1}'";
        }
        ...
        /// <summary>
        /// ISO 10110-12 / GB/T 11297.12 非球面: 矩形框 + 居中代码 "12/A B/C'" (A=轴对称/F=自由曲面, B=sag μm, C=斜率 arc-min).
        /// 旧实现 (双线框 + 装饰性抛物线 + 上下分行 12 / 公差) 不符合 ISO 10110-12 严格格式, 已移除.
        /// </summary>
        private void GenerateMainSymbol()
        {
            ...
            // 居中 ISO 代码 "12/A 0.50/1.0'" (A=轴对称, F=自由曲面)
            // 默认值 0 时不输出占位
            string typeCode = SurfaceType == AsphericType.Axisymmetric ? "A" : "F";
            string sagStr   = FormDeviation > 0 ? $"{FormDeviation:G3}" : "—";
            string slopeStr = SlopeDeviation > 0 ? $"/{SlopeDeviation:G3}'" : "";
            string codeText = $"12/{typeCode} {sagStr}{slopeStr}";
        ...
        /// <summary>
        /// ISO 10110-12: 框内代码即完整规范, 外部仅注单位 (μm, arc-min).
        /// </summary>
        ...
        public bool Validate()
        {
            ...
            if (SlopeDeviation < 0 || SlopeDeviation > 60) return false;
        ...
        public Dictionary<string, object> GetProperties()
        {
            return new Dictionary<string, object>
            {
                ...
                { "IsVisible", IsVisible }, { "SurfaceType", SurfaceType },
                { "FormDeviation", FormDeviation }, { "SlopeDeviation", SlopeDeviation },
        ...
        public void SetProperties(Dictionary<string, object> properties)
        {
            ...
            if (properties.ContainsKey("SurfaceType")) SurfaceType = (AsphericType)properties["SurfaceType"];
            if (properties.ContainsKey("FormDeviation")) FormDeviation = (double)properties["FormDeviation"];
            if (properties.ContainsKey("SlopeDeviation")) SlopeDeviation = (double)properties["SlopeDeviation"];
        ...
        {
            return $"ISO 10110-12 非球面标记 - 形状偏差: {FormDeviation}μm, 斜率: {SlopeDeviation}'";
        }
        #endregion
        ...
        public override object Clone()
        {
            ...
            mark.SurfaceType = SurfaceType;
            mark.FormDeviation = FormDeviation;
            mark.SlopeDeviation = SlopeDeviation;
    ...
    /// 非球面类型枚举
    /// </summary>
    public enum AsphericType
    {
        /// <summary>轴对称非球面</summary>
        Axisymmetric = 0,
        /// <summary>自由曲面</summary>
        Freeform = 1
    }
