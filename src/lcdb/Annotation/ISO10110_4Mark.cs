...
namespace lcdb.Annotation
{
    ...
    public class ISO10110_4Mark : Entity, IOpticalMark
    {
        ...
        public string MarkText { get; set; } = "4/2;A";  // ISO 10110-4 不均匀性条纹使用代码"4/"
        ...
        {
            // ISO 10110-4 不均匀性和条纹使用代码"4/"
            MarkText = $"4/{InhomogeneityClass};{StriaeClass}";
        }
        ...
        private void GenerateMainSymbol()
        {
            ...
            // ISO 10110-4 严格格式 "2/A;B"
            string codeText = $"2/{InhomogeneityClass};{StriaeClass}";
        ...
        {
            if (InhomogeneityClass <= 1)
                return lcdb.Colors.Color.FromColor(System.Drawing.Color.Red);      // 高精度
            else if (InhomogeneityClass <= 3)
                return lcdb.Colors.Color.FromColor(System.Drawing.Color.Orange);   // 标准级
            else
                return lcdb.Colors.Color.FromColor(System.Drawing.Color.Blue);     // 一般级
        }
        #endregion
