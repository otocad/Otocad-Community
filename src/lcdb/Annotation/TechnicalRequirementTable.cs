...
namespace lcdb.Annotation
{
    ...
    public class TechnicalRequirementTable : Entity, IOpticalMark
    {
        ...
        /// <summary>
        /// 表格行类型定义
        /// ISO 10110绘图代码: Part 5→"3/", Part 6→"4/", Part 7→"5/"。
        /// 注: 表面纹理(Part 8)**无 slash 代号**(用 G/P, ISO 10110-8 / GB13323 附录C);
        /// `6/` 是激光损伤的代号(ISO 10110-10 代号表), 故纹理行用描述标签。
        /// </summary>
        private static readonly string[] RowLabels = new string[]
        {
            ...
            "Surface texture"  // ISO 10110-8 表面纹理 G/P (无 slash 代号; 6/ 是激光, 曾误标)
        };
        ...
        private string GetLeftSurfaceValue(int rowIndex)
        {
            ...
            switch (rowIndex)
            {
                ...
                case 7: return LeftSurface.ISO10110_4_Value; // Surface texture → ISO 10110-8 纹理 G/P (注:属性名历史遗留; 纹理无 slash 代号)
                default: return "";
            }
        }
        ...
        private string GetRightSurfaceValue(int rowIndex)
        {
            ...
            switch (rowIndex)
            {
                ...
                case 7: return RightSurface.ISO10110_4_Value; // Surface texture → ISO 10110-8 纹理 G/P (注:属性名历史遗留; 纹理无 slash 代号)
                default: return "";
            }
        }
